...
`r Biocpkg("ReactomePA")` implemented the `viewPathway()` to visualize selected reactome pathways. More general purpose visualization methods for ORA and GSEA results are provided in the `r Biocpkg("enrichplot")` package and are documented in @sec-enrichplot.
...
#| fig-height: 6
#| fig-width: 8
#| fig-cap: "(ref:viewpathwaycap)"
#| fig-scap: "(ref:viewpathwayscap)"
