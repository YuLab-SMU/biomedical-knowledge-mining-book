...
# This uses local caching to avoid repeated downloads
net <- get_ppi_network(9606, output = "igraph")

# 2. Run NSEA
# (Assuming 'stats' is a named numeric vector and 'pathways' is a list of gene sets)
nsea_result <- nsea(
    geneList = stats,
    network = net,
    gene_sets = pathways
...
pr_weights <- igraph::page_rank(net)$vector
