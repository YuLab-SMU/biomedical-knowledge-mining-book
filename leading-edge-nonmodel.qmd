# Recipes: leading-edge analysis and non-model organisms {#recipes}
...
For visualization of leading edge analysis results using `cnetplot`, please refer to the [enrichplot chapter](enrichplot.qmd#sec-enrichplot).
...
- For a reusable custom annotation, continue to [universal enrichment](universal-enrichment.qmd#universal-api) or [GSON](gson.qmd#sec-gson).
- Plot leading-edge genes with [network views](enrichplot-networks.qmd#sec-visualization-networks).
