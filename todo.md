...
+ [msigdf + clusterProfiler全方位支持MSigDb](https://mp.weixin.qq.com/s/AamfRz0BUENCi_1P0P-Ruw) <!-- x -->
...
+ [use simplify to remove redundancy of enriched GO terms](https://mp.weixin.qq.com/s/wmRndNBhTBPEhrcGA-IfFg) <!-- x -->
+ [GO富集分析中的间接注释](https://mp.weixin.qq.com/s/lg6ro5iclDZUdyXjpJZY5w)
+ [靠树树会倒，不要太相信你的注释文件！](https://mp.weixin.qq.com/s/4dIt2gl-jf8n_L1mPtKXqQ)
...
+ [还想用clusterProfiler以前的那些画图函数，怎么办？](https://mp.weixin.qq.com/s/vTyZ2H4iFp3rfI45TNJPuw)
